...
export class ReceptionistService {
  private readonly receptionistUrl = `${environment.apiUrl}/receptionists`;
  private readonly appointmentUrl = `${environment.apiUrl}/appointments`;
  private readonly medicalRecordUrl = `${environment.apiUrl}/medical-records`;
